package com.test.springai.tools;
...
public class TimeTools {
    ...
    @Tool(name="getCurrentLocalTime", description = "Get the current local time in the user's timezone")
     public String getCurrentLocalTime(){
         logger.info("Runnung the current time in the user's timezone");
    ...
    public String getCurrentTime(@ToolParam(description = "Value representing the time zone") String timeZone){
        logger.info("Runnung the current time in the timezone {}",timeZone);
