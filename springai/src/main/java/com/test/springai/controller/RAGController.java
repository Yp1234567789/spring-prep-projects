...
public class RAGController {
    ...
    public RAGController(@Qualifier("chatMemoryChatClient") ChatClient chatClient, VectorStore vectorStore, @Qualifier("webSearchRAGChatClient") ChatClient webSearchChatClient) {
         this.webSearchChatClient = webSearchChatClient;
        this.chatClient = chatClient;
        this.vectorStore = vectorStore;
    }
    @GetMapping("/rag/document/chat")
